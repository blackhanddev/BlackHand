...
int64 nChainStartTime = 1513292991;
...
const string strMessageMagic = "BlackHand Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in BlackHand
    bool fStrictPayToScriptHash = true; // Always active in BlackHand
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "BlackHand", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "12/14/2017 Merry Christmas from the Black Hand.";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0x9530ccbf072d491430a21dc9e1e3e5569bb28954065437cacefac5664f1f2ae5"));
